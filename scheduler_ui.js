...
//   This ensures that manually editing a block (e.g., 12:20-1:20) correctly
//   updates the 12:00-12:30 slot, matching the Optimizer's behavior.
// -----------------------------------------------------------------

// ===== HELPERS =====
const INCREMENT\_MINS = 30; // Base optimizer grid size
...
const UI\_GENERATED\_EVENTS = new Set([
...
return UI\_GENERATED\_EVENTS.has(String(name).trim().toLowerCase());
}
...
const slotEnd = slotStart + INCREMENT\_MINS;
