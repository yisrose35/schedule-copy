// ============================================================================ // scheduler_core_utils.js // PART 1 of 3: THE FOUNDATION // // Role: // - Data Loading // - Constraint Logic (canBlockFit) // - FIX: Refined "Lookback" logic to check specific end times. // (Fixes 2:15 vs 2:20 gap while catching 2:30 vs 2:20 overlap) // ============================================================================
